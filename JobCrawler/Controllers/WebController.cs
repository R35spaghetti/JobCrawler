...
public class WebController : ControllerBase
{
    ...
    public ActionResult StartCrawlAF(string input, [FromQuery] List<string> keywords, string path,
        [FromQuery] List<string> negativeKeywords)
    {
    ...
    public ActionResult StartCrawlIndeed(string what, string where, [FromQuery] List<string> keywords, string path,
        [FromQuery] List<string> negativeKeywords)
    {
    ...
    public ActionResult StartCrawlArbetsformedlingenAndIndeed(string job, [FromQuery] List<string> keywords,
        string path, [FromQuery] List<string> negativeKeywords, string whereIndeed)
    {
